...
> [!NOTE]
> To learn more about why this template exists, read [The State of Static Blogs in 2024](https://Blogging Website.vercel.app/blog/the-state-of-static-blogs), where I share my take on what constitutes a great blogging template and my goals while developing this one.
...
export const SITE: Site = {
  ...
  description: // ...
  href: 'https://Blogging Website.vercel.app',
  featuredPostCount: 2,
  postsPerPage: 3,
}
...
<meta name="apple-mobile-web-app-title" content="Blogging Website" />
...
<a href="https://star-history.com/#jktrn/Blogging Website&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=jktrn/Blogging Website&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=jktrn/Blogging Website&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=jktrn/Blogging Website&type=Date" />
 </picture>
</a>
